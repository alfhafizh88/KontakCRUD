...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_username = (EditText) findViewById(R.id.etLoginUsername);
        txt_password = (EditText) findViewById(R.id.etLoginPassword);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent1 = new Intent(LoginActivity.this, Beranda.class);
